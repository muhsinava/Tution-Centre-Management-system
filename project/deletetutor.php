...
input {
  ...
  background-color:white;
    ...
    <div>
        ...
        <h1 align="center" style="font-size: 30px;"> DELETE TUTOR</h1>
        <form action="" method="post" name="register" >
            <label style="margin-left: 30px;margin-right: 30px;padding: 1px 20px;">
            <input type="text" name="tutorid" placeholder="TUTOR ID" style="margin-left:-5px;"><br>
...
$sql="delete from tutors where tutor_id=$tid";
